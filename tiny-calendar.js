...
events: array of objects which represents every event

@param {Object} attrs REMEMBER: use snake-case when setting these on the partial! i.e. my-attr='1' NOT myAttr='1'
week-days : string for custom day labels (eg. ['L','M','M']),
today: 'today',
allDayLabel
...
angular.module('camilloaddis.angular-tiny-calendar', []).directive('tinyCalendar', [ function() {
